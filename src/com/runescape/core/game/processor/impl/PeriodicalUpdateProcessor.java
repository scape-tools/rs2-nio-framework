...
import com.runescape.core.game.utility.IndexContainer;

public final class PeriodicalUpdateProcessor extends PeriodicalLogicProcessor {

	/**
	 * A collection supporting full concurrency of retrievals and high expected concurrency
	 * for updates. This collection is used to store active players in a index to instance
	 * relationship.
	 */
	private final ConcurrentHashMap<Integer, Player> players = new ConcurrentHashMap<Integer, Player>();

	/**
	 * A container for the assignment and organization of the player identification
	 * numbers.
	 */
	 ...
	 * 
	 * @param entity The instance of the new player.
	 */
	 ...
	 * 
	 * @param index The instance of the existing player.
	 */
	...
	public void execute() {
			...
			for (final Player player : players.values()) {
				...
				/*
				 * Determines if the update list contains a flag that denotes
				 * a regional update.
				 */
