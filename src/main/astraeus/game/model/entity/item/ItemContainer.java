package main.astraeus.game.model.entity.item;
...
public abstract class ItemContainer {
      ...
      /**
       * Constructs a new {@link ItemContainer} with a default {@link StackType} of {@code NORMAL}.
       * 
      ...
      public final boolean canHoldItem(Player player, int id) {
            ...
            if (player.getInventoryContainer().containsItem(id)
                        && ItemDefinition.getDefinitions()[id].isStackable()) {
                  return true;
            }
            return false;
      }
       ...
       * 
       * @param items The array of items for this container.
       */
