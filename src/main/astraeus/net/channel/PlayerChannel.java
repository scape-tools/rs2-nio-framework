...
import main.astraeus.net.channel.events.PrepareChannelEvent;
...
public final class PlayerChannel {
      ...
      /**
       * Returns an instance of the token representing the registration of a channel.
       * 
      ...
      /**
       * Returns an instance of the player connecting through this channel.
       * 
       * @return The returned instance.
       */
       ...
       * 
       * @param writer The message of interest.
       * 
       * @param buffer The internal buffer.
       * 
       */
      public final void prepare(OutgoingPacket packet, PacketWriter writer) {
            execute(new PrepareChannelEvent(packet.getOpcode(), packet.getHeader(), writer));
      }
