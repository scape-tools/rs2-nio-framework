package main.astraeus.net.packet.outgoing;
...
public abstract class OutgoingPacket {
       ...
       * 
       * @throws IOException The exception thrown if an error occurs while building or dispensing
       *         the packet.
       */
      public abstract PacketWriter encode(Player player);
      
      /**
       * Creates a new {@link OutgoingPacket} with a default {@link PacketHeader} of
       * {@code STANDARD}.
       * 
       * @param opcode The id of this packet.
       * 
       * @param allocate The allocation of this buffer.
       */
      public OutgoingPacket(int opcode, int allocate) {
            this(opcode, PacketHeader.FIXED, allocate);
      }
